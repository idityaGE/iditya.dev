...
export const metadata: Metadata = {
  title: "Blog RSS Feed",
  description: "Subscribe to get updates on my latest blog posts.",
};
  ...
  return (
    <div className="mt-10 px-4">
      <header className="mb-10">
        <h1 className="text-3xl font-medium font-grid mb-4">Blog RSS Feed</h1>
        <p className="text-base text-muted-foreground">
          Subscribe to get updates on my latest blog posts.
        </p>
      </header>

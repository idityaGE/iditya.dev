...
export const Hero = () => {
  return (
    <div className="ml-4 mb-4">
      <h1 id="name" className="text-4xl font-bold leading-12">
        I'm <br /> {PersonalData.name}
      </h1>
      <div>
        <h6 className="text-base text-muted-foreground pt-3">
      ...
      <div className="mt-5">
        <h6 className="text-base text-muted-foreground">
          ...
          >
            ...
            <b className="font-semibold underline underline-offset-2 pl-1">
              <strong>{LinkData.gmail}</strong>
            </b>
          </a>
          .
        </h6>
      ...
      <h1 id="name" className="text-4xl font-bold leading-12 pt-10">
        About me
      </h1>
    </div>
  );

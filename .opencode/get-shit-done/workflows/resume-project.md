...
<required_reading>
@/home/idityage/github_repos/nextport/.opencode/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/home/idityage/github_repos/nextport/.opencode/get-shit-done/bin/gsd-tools.cjs" init resume)

...
- **Global scope**: `/home/idityage/github_repos/nextport/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/idityage/github_repos/nextport/.opencode/notes/`)
...
2. Glob `/home/idityage/github_repos/nextport/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/home/idityage/github_repos/nextport/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/idityage/github_repos/nextport/.opencode/notes/` — works in any directory

...
export const LinkData = {
  ...
  gmail: "idityage@gmail.com",
  mail: "mailto:idityage@gmail.com?subject=Hello%20!",
};
...
const skillList = {
  ...
  "Web 3": ["Web3.js", "@solana/web3.js", "Solana", "Ethereum", "Solidity"],
  ...
  Tools: ["Git", "GitHub", "Visual Studio Code", "Linux", "Bash"],
  Languages: ["TypeScript", "Go", "C", "C++", "Java", "Rust", "Python"],
};

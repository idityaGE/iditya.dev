        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px">
          ...
          <div className="bg-background p-3 border-b md:border-r md:border-b-0">
            ...
            <div className="flex flex-wrap gap-x-3 gap-y-1">
              <Link href="/" className="text-xs font-mono text-muted-foreground hover:text-green-500 transition-colors">
                <GreenArrow /> home
              </Link>
              <Link href="/projects" className="text-xs font-mono text-muted-foreground hover:text-green-500 transition-colors">
                <GreenArrow /> projects
              </Link>
              <Link href="/blogs" className="text-xs font-mono text-muted-foreground hover:text-green-500 transition-colors">
                <GreenArrow /> blogs
              </Link>
              <Link href="/pow" className="text-xs font-mono text-muted-foreground hover:text-green-500 transition-colors">
                <GreenArrow /> proof of work
              </Link>
              <Link href="/rss.xml" target="_blank" rel="noopener noreferrer" className="text-xs font-mono text-muted-foreground hover:text-green-500 transition-colors">
                <GreenArrow /> rss
              </Link>
            </div>
          </div>

...
Use template from `/home/idityage/github_repos/nextport/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/idityage/github_repos/nextport/.opencode/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/idityage/github_repos/nextport/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
